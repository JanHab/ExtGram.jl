...
# # Inverse of moments_init for rotation
# moments_testing = []
# for i in 1:length(moments_init)
#     if moments_init[i] != 0.0
#         push!(moments_testing, Num(moments_init[i]))
#     end
# end
# moments_reallocating = zeros(Num, length(moments_init))
# j = 1
# for i in slab_indices
#     moments_reallocating[i] = moments_testing[j]
#     j += 1
# end
