...
display(p1)
savefig(p1, "out/Riemann1D/bgk_N$(N)_Kn$(Kn)_T_end$(T_end)_rho_L$(ρ_L)_rho_R$(ρ_R)_v_L$(v_L)_v_R$(v_R)_theta_L$(θ_L)_theta_R$(θ_R)_ρ_v_p_base_tree_level$(base_tree_level)_polydeg$(polydeg).pdf")

# Store primitive variables in CSV file
CSV.write(
    "out/Riemann1D/bgk_N$(N)_Kn$(Kn)_T_end$(T_end)_rho_L$(ρ_L)_rho_R$(ρ_R)_v_L$(v_L)_v_R$(v_R)_theta_L$(θ_L)_theta_R$(θ_R)_ρ_v_p_base_tree_level$(base_tree_level)_polydeg$(polydeg).csv",
