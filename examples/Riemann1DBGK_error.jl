...
# Parameter
N_vector = [1000] #![10, 20, 30, 50, 100, 150, 200, 250]
c_l = -6.0
c_u = 6.0
...
for N in N_vector
    ...
    callbacks, summary_callback = callbacksGramianMomentEquations(
        ...
        name="Riemann1D/bgk_solution_N$(N)_Kn$(Kn)_T_end$(T_end)_rho_L$(ρ_L)_rho_R$(ρ_R)_v_L$(v_L)_v_R$(v_R)_theta_L$(θ_L)_theta_R$(θ_R)", # name of output files
    )
    ...
    display(p1)
    savefig(p1, "out/Riemann1D/bgk_N$(N)_Kn$(Kn)_T_end$(T_end)_rho_L$(ρ_L)_rho_R$(ρ_R)_v_L$(v_L)_v_R$(v_R)_theta_L$(θ_L)_theta_R$(θ_R)_ρ_v_p.pdf")

    # Store primitive variables in CSV file
    CSV.write(
        "out/Riemann1D/bgk_N$(N)_Kn$(Kn)_T_end$(T_end)_rho_L$(ρ_L)_rho_R$(ρ_R)_v_L$(v_L)_v_R$(v_R)_theta_L$(θ_L)_theta_R$(θ_R)_ρ_v_p.csv",
