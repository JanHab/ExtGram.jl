...
val_1D1D_left = ExtGram.closure(left_1D1D, equations_1D1D)
val_1D1D_right = ExtGram.closure(right_1D1D, equations_1D1D)

equations_1D3D = GramianMomentEquations1D3D(M, Kn, closure)
val_1D3D_left = ExtGram.closure_transform(left_1D3D, equations_1D3D)
val_1D3D_right = ExtGram.closure_transform(right_1D3D, equations_1D3D)
